...
class DocGenerator:
    ...
    def save_document(self, document, company_name, meeting_date):
        ...
        # Use the provided meeting date for the filename
        date_str = datetime.datetime.strptime(meeting_date, "%Y-%m-%d").strftime("%Y-%m-%d")
...
class DocGeneratorApp(QMainWindow):
    ...
    def generate_document_from_input(self):
        ...
        if document is not None:
            file_path = self.doc_generator.save_document(document, company_name, meeting_date)
